...
public class ZipHelper
{
	...
	public static void ZipFileDirectory(string strDirectory, string zipedFile, int zipLevel = 6){ Debug.LogError("[ZipHelper](ZipFileDirectory)you are in the hell");}
...
public class ZipHelper
{
    ...
    public static void ZipFileDirectory(string strDirectory, string zipedFile, int zipLevel = 6)
    {
        using (System.IO.FileStream ZipFile = System.IO.File.Create(zipedFile))
        {
