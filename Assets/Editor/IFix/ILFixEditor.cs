...
namespace IFix.Editor
{
    ...
    public class IFixEditor
    {
        ...
        public static void GenPatch(string assembly, string assemblyCSharpPath
            ...
            string corePath = "./Assets/Plugins/IFix/IFix.Core.dll", string patchPath = "Assets/ABundles/IFixPatches/Assembly-CSharp.patch.bytes")
        {
        ...
        public static void Patch()
        {
            ...
            try
            {
                foreach (var assembly in injectAssemblys)
                {
                    ...
                    GenPatch(assembly, assembly_path, "./Assets/Plugins/IFix/IFix.Core.dll",
                        string.Format("Assets/ABundles/IFixPatches/{0}.patch.bytes", assembly));
                }
            }
            catch (Exception e)
            {
